 ...
 * user's hand, or in the air after it (src/desk/grab.ts). No hamster *state* maps to these three.
 */
export type IsoAnim = 'idle' | 'blink' | 'type' | 'read' | 'think' | 'talk' | 'wave' | 'walk' | 'phone' | 'sleep' | 'run' | 'scold' | 'flinch' | 'struggle'
